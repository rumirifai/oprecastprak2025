...
const events: TimelineEvent[] = [
  {
    ...
    steps: [
      'Active Student of Teknik Informatika Universitas Padjadjaran and currently in third year (2020) or second year (2021).',
      'Minimum GPA 3.00.',
  ...
  },
  {
    ...
    additionalSteps: [
      'Make sure your face is shown and your voice can be heard clearly',
      'Introduce yourself',
  ...
  },
  {
    ...
    steps: [
      ...
      'File format for the submission is NPM.pdf',
